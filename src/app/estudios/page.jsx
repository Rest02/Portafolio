...
function Page() {
  return (
    <div className="container mx-auto py-16 px-4">
      <div className="mb-12">
        <h1 className="text-3xl font-mono mb-8">Mis Estudios</h1>
      </div>
      <div className="flex items-center justify-center">
        <div className="border rounded-4xl flex flex-col md:flex-row w-full max-w-[700px] p-6 shadow-lg bg-white">
          ...
          <div className="flex flex-col flex-1">
            ...
            <div className="mt-3 flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 justify-end">
              <div className="flex-1">
                <button className="px-4 py-2 bg-neutral-300 text-black rounded-4xl shadow hover:bg-neutral-200 transition border w-full">
